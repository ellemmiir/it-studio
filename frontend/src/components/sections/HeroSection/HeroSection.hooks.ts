...
//     texts.current = shuffled;
//   }, [initialTexts]);

//   useEffect(() => {
//     const interval = setInterval(() => {
//       const currentText = texts.current[currentIndex];
...
//             if (prev === texts.current.length - 1) {
//               const newArray = [...texts.current].sort(() => Math.random() - 0.5);
//               texts.current = newArray;
//               return 0;
//             }
//             return prev + 1;
//           });
