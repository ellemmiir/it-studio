          ...
          {activeServices.map((service) => {
            ...
            return (
              ...
              >
                ...
                <div className="border-grey-300 group-hover:bg-grey-200 border-b px-4 pt-14 pb-6 transition-colors duration-300">
                  <div className="grid grid-cols-1 items-start gap-6 lg:grid-cols-12">
                    ...
                    <div className="lg:col-span-5">
                      <p className="text-grey-800 max-w-[95%]">
                        {service.description}
                      </p>
                    </div>
                    ...
                    <div className="lg:col-span-3">
                      <div className="space-y-4">
                        <div className="border-grey-300 flex items-center justify-between border-b">
                          <span className="text-grey-700 text-sm">Рынок:</span>
